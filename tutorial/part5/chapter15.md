...
Our starting template is the following, you can download it [here](https://github.com/open-resources/dash_curriculum/blob/main/tutorial/part5/ch15_files/app_v1.zip?raw=true) (the .zip file will need to be uncompressed):
