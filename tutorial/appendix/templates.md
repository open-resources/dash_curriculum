...
Below each template you find the corresponding code to incorporate into your main app.py file. The other files are the same as for both dashboards, you can [download them here](./pages.zip).
