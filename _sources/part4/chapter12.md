...
- A variety of classnames
  ...
  - margin  `m-1`
  - padding `p-1`# Chapter 12  Advanced Styling and Layout
...
[![enter image description here][30]][30]
  ...
  [27]: https://i.stack.imgur.com/fkHbn.png
  [28]: https://i.stack.imgur.com/BdGEE.png
  [29]: https://i.stack.imgur.com/NGfOi.png
  [30]: https://i.stack.imgur.com/EJw6S.png  - rounded edges `rounded`
  - opacity `opacity-25`
- How multiple features are referenced in the same className call `"text-info bg-primary"`
- How the same component part can be referenced mutliple times with `"bg-primary bg-opacity-25"`
- Special layout attributes for `dbc.Row()`
...
[![enter image description here][30]][30]
  ...
  [28]: https://i.stack.imgur.com/BdGEE.png
  [29]: https://i.stack.imgur.com/NGfOi.png
  [30]: https://i.stack.imgur.com/EJw6S.png
