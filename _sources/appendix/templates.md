...
app.layout = html.Div([
    ...
    dbc.Container([
        dbc.Tabs([
            dbc.Tab([
                dbc.Card([
                    dbc.CardBody([
                        dbc.Row([
                            dbc.Col([
                                dbc.Card(dcc.Graph(figure=fig_ba), color="light")
                            ]),
                        ]),
                        html.Br(),
                        dbc.Row([
            ...
            ], label='Bar plot', activeLabelClassName='bg-light'),
            dbc.Tab([
                dbc.Card([
                    dbc.CardBody([
                        dbc.Row([
                            ...
                            dbc.Col(dbc.Card(dcc.Graph(figure=fig), color="light"), width=8),
                        ])
                    ])
                ])
            ], label='Line plot', activeLabelClassName='bg-light'),
            dbc.Tab([
                dbc.Card([
                    dbc.CardBody([
            ...
            ], label='Scatter plot', activeLabelClassName='bg-light')
        ])
    ])
])
