...
Now let's create a more advanced `multi-page` app.  We'll use a `dropdown` component to navigate between pages.  For the pages themselves we'll use examples from previous chapters.
