...
As you can tell from the figure, you can now study the change in the total populations of these countries over the years. This makes sense for `population`, but not so much if you were to study life expectancies. The next section will introduce how to edit `barmode` both in the function call and *after* you've produced the figure.
...
By default `px.bar()` uses `barmode = 'stacked'` which does exactly what it says, namely stacking the populations for each `country` discerned by `color` on top of each other. But you can change this behavior through `barmode = 'group'`.
...
[Plotly: How to make different plots using plotly?](https://stackoverflow.com/questions/66664935/plotly-how-to-make-different-plots-using-plotly-as-a-plotting-backend-for-panda/66664937#66664937)
  ...
  [8]: https://i.stack.imgur.com/MYpK9.png
  [9]: https://i.stack.imgur.com/ENAiB.png
  [10]: https://i.stack.imgur.com/82TrL.png
  [11]: https://i.stack.imgur.com/EEylA.png
  [12]: https://i.stack.imgur.com/lDZUC.png
  [13]: https://i.stack.imgur.com/MHR22.png
  [14]: https://plotly.com/python/linear-fits/
  [15]: https://plotly.com/python/graph-objects/
  [16]: https://i.stack.imgur.com/FFZFt.png
  [17]: https://plotly.com/python/line-and-scatter/#scatter-and-line-plots-with-goscatter
  [18]: https://plotly.com/python/reference/layout/
  [19]: https://i.stack.imgur.com/X88Ak.png
  [20]: https://i.stack.imgur.com/rSm7d.png
  [21]: https://i.stack.imgur.com/lCE6Y.png
  [22]: https://i.stack.imgur.com/N1uHD.png
  [23]: https://i.stack.imgur.com/B708M.png
  [24]: https://i.stack.imgur.com/VSCj0.png
  [25]: https://i.stack.imgur.com/xo5iL.png
  [26]: https://i.stack.imgur.com/bGs6b.png
